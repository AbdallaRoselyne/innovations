      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          <p className="text-gray-600 mb-6">
            The main cause of climate change is burning fossil fuels such as oil, gas, and coal. They are by far the largest contributor to global climate change, accounting for over 75 per cent of global greenhouse gas emissions and nearly 90 per cent of all carbon dioxide emissions (UN).
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-prodesign-blue pl-4">
                <h4 className="text-lg font-semibold text-gray-800 mb-2">Electric Scooters</h4>
                <p className="text-gray-600">
              ...
              <div className="border-l-4 border-prodesign-blue pl-4">
                <h4 className="text-lg font-semibold text-gray-800 mb-2">Other Models in Development</h4>
              ...
              <div className="bg-prodesign-blue text-white p-6 rounded-lg">
                <h4 className="text-xl font-semibold mb-2">Looking for Investors</h4>
                <p>
                  We have several other models under design and one of our key objective is to develop an electric single passenger car, designed and manufactured in Mauritius.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md">
              <img src="/ev-1.jpg" alt="EV Project" className="w-full h-full object-cover" />
            </div>
            <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md">
              <img src="/ev-2.jpg" alt="EV Project" className="w-full h-full object-cover" />
            </div>
            <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md col-span-2">
              <img src="/ev-3.jpg" alt="EV Project" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </div>
