      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mb-6">
              Interested in our projects or want to partner with us? Send us a message and we'll get back to you as soon as possible.
            </p>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p>info@prodesign-innovation.com</p>
                </div>
              </div>
              <div className="flex items-start">
                <svg className="w-6 h-6 mr-4 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p>123 Innovation Road, Ebene, Mauritius</p>
                </div>
              </div>
            </div>
          </div>
