      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="text-center mb-16">
          ...
          <div className="relative inline-block">
            ...
            <svg
              className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-24 h-2"
              viewBox="0 0 100 10"
            >
              <path
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {workItems.map((item, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-300`}
              ></div>

              {/* SVG decoration */}
              <svg
                className="absolute top-4 right-4 w-12 h-12 opacity-10 group-hover:opacity-20 transition-opacity duration-300"
                viewBox="0 0 100 100"
              >
                <circle
                  cx="50"
              ...
              <div className="relative z-10">
                <div
                  className={`w-16 h-16 rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center text-white mb-6 group-hover:bg-white group-hover:text-blue-600 transition-colors duration-300`}
                >
                ...
                >
                  ...
                  <FontAwesomeIcon
                    icon={faArrowRight}
                    className="ml-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-x-1"
                  />
                </Link>
              </div>
            </div>
